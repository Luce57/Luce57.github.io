...
<div class="container_inscriptionConnexion">
    ...
    <div class="inscription">
        ...
        ?>
        <h1>Connexion</h1>
        <form action="<?php $_SERVER['DOCUMENT_ROOT'] ?>/controller/connexionController.php" method="POST">
...
<div id="resetForm" style="display: none;">
    ...
    <form action="<?php $_SERVER['DOCUMENT_ROOT'] ?>/controller/resetPasswordController.php" method="POST">
